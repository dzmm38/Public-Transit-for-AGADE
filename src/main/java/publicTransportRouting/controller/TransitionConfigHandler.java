 ...
 */
public class TransitionConfigHandler {
    //------------------------------------------ Variable -------------------------------------------//
    ...
    //----------------------------------------- Constructor -----------------------------------------//
    public TransitionConfigHandler() {
        //only to create a TransitionConfigHandler from a YAML File
    }

    public TransitionConfigHandler(String graph_flag_encoders, String datareader_file, String graph_Location, String gtfs_file) {
    ...
    //------------------------------------------- Methods -------------------------------------------//
    /**
     * Method to switch form a TransitionConfigHandler class to a GraphhopperConfig class
